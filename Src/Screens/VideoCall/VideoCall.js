...
import { ZegoUIKitPrebuiltCall, ONE_ON_ONE_VIDEO_CALL_CONFIG, ZegoSendCallInvitationButton } from '@zegocloud/zego-uikit-prebuilt-call-rn'
    ...
    return (
        <View style={styles.container}>
            ...
            <ZegoUIKitPrebuiltCall
                ...
                userName={'Ahmad'}
                callID={'synergy_786'} // callID can be any unique string. 
